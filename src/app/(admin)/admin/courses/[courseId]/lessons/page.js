      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 pb-6 border-b border-slate-800">
        ...
        <div className="flex items-center gap-3 self-start sm:self-auto">
          <Link
            ...
            className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#175cff] to-[#fa8b98] text-white font-extrabold hover:shadow-lg hover:shadow-[#fa8b98]/20 text-xs flex items-center gap-2"
          >
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Link
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${
                !selectedModuleId
                  ? 'bg-[#fa8b98] text-slate-950 font-extrabold'
                  ...
                  <tr key={lsn.id} className="hover:bg-slate-900/50 transition-colors">
                    ...
                    <td className="p-4">
                      {lsn.lesson_type === 'live_class' ? (
                        ...
                        <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded bg-slate-800 text-[#fa8b98] font-semibold text-[11px] capitalize">
